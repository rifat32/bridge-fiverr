...
Route::prefix('company')->group(function () {
    Route::post('login', 'API\ECompany\UserAPIController@login');
    Route::post('register', 'API\ECompany\UserAPIController@register');
    Route::post('send_reset_link_email', 'API\UserAPIController@sendResetLinkEmail');
    Route::get('user', 'API\ECompany\UserAPIController@user');
    Route::get('logout', 'API\ECompany\UserAPIController@logout');
    Route::get('settings', 'API\ECompany\UserAPIController@settings');
});
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::group(['middleware' => ['role:company']], function () {
        Route::prefix('company')->group(function () {
            Route::post('users/{user}', 'API\UserAPIController@update');
            Route::get('dashboard', 'API\DashboardAPIController@company');
            Route::resource('e_providers', 'API\EProvider\EProviderAPIController');
            Route::resource('notifications', 'API\NotificationAPIController');
            Route::get('e_service_reviews', 'API\EServiceReviewAPIController@index')->name('e_service_reviews.index');
            Route::get('e_services', 'API\EServiceAPIController@index')->name('e_services.index');
